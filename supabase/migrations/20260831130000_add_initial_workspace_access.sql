...
-- Add initial workspace access to the organization
...
BEGIN
    ...
    -- ------------------------------------------------------------
    -- 11. Establish workspace membership.
    -- ------------------------------------------------------------
    ...
    -- ------------------------------------------------------------
    -- 12. Grant workspace access.
    --
    -- Membership and authorization to access a workspace
    -- are intentionally separate relationships.
    -- ------------------------------------------------------------
    ...
    -- ------------------------------------------------------------
    -- 13. Return the newly-created foundation IDs.
    -- ------------------------------------------------------------
