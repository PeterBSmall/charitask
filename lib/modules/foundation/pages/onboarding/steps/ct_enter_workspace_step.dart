...
class CTWorkspaceCompletionScreen extends StatelessWidget {
              ...
              Expanded(
                child: narrow
                    ? SingleChildScrollView(
                        child: _buildCardsColumn(context, compact: compact),
                      )
                    : _buildCardsRow(context, compact: compact),
              ),
  ...
  Widget _buildCardsRow(BuildContext context, {required bool compact}) {
    return Row(
      ...
      children: [
        Expanded(
          child: _ActionCard(
            ...
            description:
                'Finish your personal profile and continue setting up your personal workspace.',
            highlights: const [
  ...
  Widget _buildCardsColumn(BuildContext context, {required bool compact}) {
    return Column(
      children: [
        _ActionCard(
          icon: Icons.person_outline_rounded,
